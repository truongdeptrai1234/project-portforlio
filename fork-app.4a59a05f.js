...
var _viewRecipesJs = require("./View/viewRecipes.js");
var _viewRecipesJsDefault = parcelHelpers.interopDefault(_viewRecipesJs);
var _viewSearchJs = require("./View/viewSearch.js");
var _viewSearchJsDefault = parcelHelpers.interopDefault(_viewSearchJs);
var _viewSearchResultJs = require("./View/viewSearchResult.js");
var _viewSearchResultJsDefault = parcelHelpers.interopDefault(_viewSearchResultJs);
var _viewPagResultJs = require("./View/viewPagResult.js");
var _viewPagResultJsDefault = parcelHelpers.interopDefault(_viewPagResultJs);
var _viewBookmarkJs = require("./View/viewBookmark.js");
var _viewBookmarkJsDefault = parcelHelpers.interopDefault(_viewBookmarkJs);
var _viewAddRecipeJs = require("./View/viewAddRecipe.js");
var _viewAddRecipeJsDefault = parcelHelpers.interopDefault(_viewAddRecipeJs);
var _configJs = require("./config.js");
const loadRecipeController = async function() {
    try {
        const id = window.location.hash.slice(1);
        if (!id) return;
        _modelJs.state.search.result.length > 0 && (0, _viewSearchResultJsDefault.default).updatePreviewDOM(_modelJs.state.search.pagResult, id);
        _modelJs.state.bookmarks.length > 0 && (0, _viewBookmarkJsDefault.default).updatePreviewDOM(_modelJs.state.bookmarks, id);
        (0, _viewRecipesJsDefault.default).loadingSpinner();
        await _modelJs.loadRecipe(id);
        (0, _viewRecipesJsDefault.default).render(_modelJs.state.recipe);
    } catch (error) {
        (0, _viewRecipesJsDefault.default).renderError();
    }
};
const searchController = async function() {
    try {
        (0, _viewSearchResultJsDefault.default).loadingSpinner();
        const query = (0, _viewSearchJsDefault.default).getQuery();
        if (!query) return;
        await _modelJs.loadSearchResult(query);
    } catch (error) {
        (0, _viewSearchResultJsDefault.default).renderError();
    }
};
const paginationController = async function() {
    const page = _modelJs.state.search.page;
    (0, _viewSearchResultJsDefault.default).render(_modelJs.getPaginationPage(page));
    (0, _viewPagResultJsDefault.default).render(_modelJs.state.search);
};
const pageUpdateController = async function(btnType) {
    btnType === "next" ? _modelJs.state.search.page++ : _modelJs.state.search.page--;
    paginationController();
};
const updateServingsController = function(newServings) {
    if (newServings < 1) return;
    _modelJs.updateServings(newServings);
    (0, _viewRecipesJsDefault.default).updateDOM(_modelJs.state.recipe); //not re-render the whole DOM
};
const bookmarkController = function() {
    _modelJs.addBookmark();
    _modelJs.setBookmarkStorage();
    (0, _viewRecipesJsDefault.default).updateDOM(_modelJs.state.recipe);
    (0, _viewBookmarkJsDefault.default).render(_modelJs.state.bookmarks, _modelJs.state.recipe.recipe.id, true);
};
const addRecipeController = async function(newRecipe) {
    try {
        (0, _viewAddRecipeJsDefault.default).loadingSpinner();
        await _modelJs.uploadRecipeData(newRecipe);
        (0, _viewAddRecipeJsDefault.default).renderMessage();
        setTimeout(()=>{
            (0, _viewAddRecipeJsDefault.default)._toggleModal();
            (0, _viewRecipesJsDefault.default).render(_modelJs.state.recipe);
        }, (0, _configJs.MODAL_CLOSE_SEC) * 1000);
        _modelJs.setBookmarkStorage();
        (0, _viewBookmarkJsDefault.default).render(_modelJs.state.bookmarks, _modelJs.state.recipe.recipe.id, true);
    } catch (error) {
        (0, _viewAddRecipeJsDefault.default).renderError(error.message); //modal error;
    }
};
const initBookmarkController = function() {
    (0, _viewBookmarkJsDefault.default).render(_modelJs.state.bookmarks, "", true);
};
const init = function() {
    window.location.hash = ""; //reset url when refresh , only for dev
    (0, _viewRecipesJsDefault.default).addLoadRecipeHandler(loadRecipeController);
    (0, _viewRecipesJsDefault.default).addUpdateServingsHandler(updateServingsController);
    (0, _viewRecipesJsDefault.default).addBookmarkHandler(bookmarkController);
    (0, _viewSearchJsDefault.default).addLoadSearchHandler(searchController, paginationController);
    (0, _viewPagResultJsDefault.default).addButtonPagHandler(pageUpdateController);
    (0, _viewBookmarkJsDefault.default).addLoadBookmarkHandler(initBookmarkController);
    (0, _viewAddRecipeJsDefault.default).addNewRecipeHandler(addRecipeController);
};
init();

},{"core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","./model.js":"3QBkH","./View/viewRecipes.js":"giQz8","./View/viewSearch.js":"e6Cbx","./View/viewSearchResult.js":"44LEY","./View/viewPagResult.js":"1jYHo","./View/viewBookmark.js":"atMiN","./View/viewAddRecipe.js":"3pzpZ","./config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
parcelHelpers.export(exports, "getPaginationPage", ()=>getPaginationPage);
parcelHelpers.export(exports, "updateServings", ()=>updateServings);
parcelHelpers.export(exports, "addBookmark", ()=>addBookmark);
parcelHelpers.export(exports, "storageBookmarks", ()=>storageBookmarks);
parcelHelpers.export(exports, "setBookmarkStorage", ()=>setBookmarkStorage);
...
const loadRecipe = async function(id) {
    try {
        ...
        const data = await Promise.race([
            (0, _helper.AJAX)(`${(0, _config.API_URL)}/${id}?key=${(0, _config.KEY)}`),
            (0, _helper.timeout)((0, _config.TIME_OUT))
        ]);
        state.recipe = data;
        state.recipe.bookmark = state.bookmarks.some((bookmark)=>bookmark.recipe.id === id);
    } catch (error) {
        throw error;
    }
};
const loadSearchResult = async function(query) {
    try {
        if (!query) return;
        const data = await Promise.race([
            (0, _helper.AJAX)(`${(0, _config.API_URL)}?search=${query}&key=${(0, _config.KEY)}`),
            (0, _helper.timeout)((0, _config.TIME_OUT))
        ]);
        state.search.query = query;
        state.search.page = 1; //reset page to 1
        state.search.result = data.recipes;
        state.search.totalPage = Math.ceil(state.search.result.length / (0, _config.RES_PER_PAGE));
    } catch (error) {
        throw error;
    }
};
const getPaginationPage = function(page) {
    return state.search.pagResult = state.search.result.slice((page - 1) * (0, _config.RES_PER_PAGE), page * (0, _config.RES_PER_PAGE));
};
...
const addBookmark = function() {
    ...
    state.bookmarks = state.recipe.bookmark ? [
        ...state.bookmarks,
        state.recipe
    ] : state.bookmarks.filter((bookmark)=>bookmark.recipe.id !== state.recipe.recipe.id);
};
...
const uploadRecipeData = async function(newRecipe) {
    try {
        ...
        const ingredients = newRecipe.filter(([field])=>field.startsWith("ingredient")).map(([, value])=>value.match(regexpIng) ? value.split(",") : []).map((value)=>{
            const [quantity, unit, description] = value;
            if (!description) return null;
            console.log(quantity);
            return {
                quantity: quantity ? new (0, _fractionJsDefault.default)(quantity).valueOf() : null,
                unit: unit ? unit.trim() : "",
        ...
        const uploadRecipe = {
            title: (0, _helper.inputFormValidate)(recipe.title, "text") ? recipe.title : null,
            publisher: (0, _helper.inputFormValidate)(recipe.publisher, "text") ? recipe.publisher : null,
            source_url: (0, _helper.inputFormValidate)(recipe.sourceUrl, "url") ? recipe.sourceUrl : null,
            image_url: (0, _helper.inputFormValidate)(recipe.image, "url") ? recipe.image : null,
            servings: (0, _helper.inputFormValidate)(recipe.servings, "number") ? +recipe.servings : 1,
            cooking_time: (0, _helper.inputFormValidate)(recipe.cookingTime, "number") ? +recipe.cookingTime : 1,
            ingredients
        };
        Object.values(uploadRecipe).forEach((value)=>{
            if (!value || value.length === 0) throw new Error("Please fill all the recipe data 's fields or check the format");
        });
        const { data } = await (0, _helper.AJAX)(`${(0, _config.API_URL)}?key=${(0, _config.KEY)}`, uploadRecipe);
        state.recipe = data;
        addBookmark();
    } catch (error) {
        throw error;
...
},{"core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","./config":"2hPh4","./View/helper":"liTIq","fraction.js":"md6n5","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"2hPh4":[function(require,module,exports,__globalThis) {
// store const variable to reuse
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY = "283c75b6-99ef-4070-b557-d803aabb20a5";
...
},{}],"liTIq":[function(require,module,exports,__globalThis) {
// store reuse function
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "timeout", ()=>timeout);
parcelHelpers.export(exports, "AJAX", ()=>AJAX);
parcelHelpers.export(exports, "inputFormValidate", ()=>inputFormValidate);
...
const AJAX = async function(url, uploadRecipe = null) {
    try {
        const pro = uploadRecipe ? await fetch(url, {
            method: "POST",
            headers: {
...
const inputFormValidate = function(input, type) {
    switch(type){
        case "text":
            return input.trim() !== "";
        case "number":
...
},{}],"giQz8":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _webImmediateJs = require("core-js/modules/web.immediate.js");
...
class viewRecipes extends (0, _viewDefault.default) {
    //public field
    //private field
    _data;
    ...
    updateDOM(data) {
        ...
        const newDOM = Array.from(document.createRange().createContextualFragment(this._recipeRender(data)).querySelectorAll("*"));
        //compare two DOM
        curDOM.forEach((cur, i)=>{
            if (cur.firstChild?.nodeValue.trim() !== newDOM[i].firstChild?.nodeValue.trim() || cur.firstElementChild?.outerHTML !== newDOM[i].firstElementChild?.outerHTML) cur.innerHTML = newDOM[i].innerHTML;
        });
    }
    render(data = "") {
        if (!data) return;
    ...
    #generateHtmlIng(data) {
        return data.recipe.ingredients.map((ing)=>ing ? `
    ...
    _recipeRender(data = "") {
        ...
        <img src="${data.recipe.image_url}" alt="${data.recipe.title}" class="recipe__img" />
          ...
          <div class="recipe__details">
            <div class="recipe__info">
              ...
              <span class="recipe__info-data recipe__info-data--minutes">${data.recipe.cooking_time}</span>
            ...
            <div class="recipe__info">
              ...
              <span class="recipe__info-data recipe__info-data--people">${data.recipe.servings}</span>
            ...
            <div class="recipe__user-generated ${data.recipe.key ? "" : "hidden"}">
              <svg>
            ...
            <button class="btn--round">
              <svg class="">
                <use href="${0, _iconsSvgDefault.default}#icon-bookmark${data.bookmark ? "-fill" : ""}"></use>
              </svg>
            </button>
          </div>
          ...
          <div class="recipe__directions">
            ...
            <p class="recipe__directions-text">
              ...
              <span class="recipe__publisher">${data.recipe.publisher}</span>. Please check out
...
exports.default = new viewRecipes();

},{"core-js/modules/web.immediate.js":"bzsBv","url:../../img/icons.svg":"fd0vu","regenerator-runtime/runtime":"f6ot0","fraction.js":"md6n5","./view":"b3RBV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fd0vu":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("icons.0809ef97.svg") + "?" + Date.now();

},{}],"b3RBV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
    ...
    updatePreviewDOM(data, hashId) {
        const curDOM = Array.from(this._parentEle.querySelectorAll("*"));
        //create a virtual DOM
        const newDOM = Array.from(document.createRange().createContextualFragment(this._renderListRecipe(data, hashId)).querySelectorAll("*"));
        //compare two DOM
        curDOM.forEach((cur, i)=>{
            if (Array.from(cur.classList).at(-1) !== Array.from(newDOM[i].classList).at(-1)) cur.classList.toggle("preview__link--active");
        });
    }
    render(data, hashId = "", isBookmark = false) {
        if (!data || data.length === 0) return isBookmark ? this.renderMessage() : this.renderError();
        this._data = data;
        this._clear();
    ...
    addButtonPagHandler(handler) {
        this._parentEle.addEventListener("click", function(e) {
            if (e.target.closest(".pagination__btn--prev")) handler("prev");
            if (e.target.closest(".pagination__btn--next")) handler("next");
        });
    }
    addUpdateServingsHandler(handler) {
        const thisRecipe = this;
        this._parentEle.addEventListener("click", function(e) {
            let serving = +thisRecipe._parentEle.querySelector(".recipe__info-data--people").textContent;
...
},{"url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"e6Cbx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class viewSearch extends (0, _viewDefault.default) {
    //private field
...
},{"./view":"b3RBV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"44LEY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class viewSearchResult extends (0, _viewDefault.default) {
    //private field
    ...
    #generateHtml(data = "", hashId) {
        return `<li class="preview">
            <a class="preview__link ${data.id === hashId ? "preview__link--active" : ""}" href="#${data.id}">
...
exports.default = new viewSearchResult();

},{"url:../../img/icons.svg":"fd0vu","./view":"b3RBV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1jYHo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class ViewPagResult extends (0, _viewDefault.default) {
    //protected field
    _data = "";
    ...
    render(data) {
        this._data = data;
        this._clear();
        this._parentEle.insertAdjacentHTML("afterbegin", this.#generateHtml(this._data));
    }
    #checkPagination(data) {
        if (data.totalPage === 1) return "";
        if (data.page === 1) return this._buttonNextMarkupHtml(data);
        if (data.page > 1 && data.page < data.totalPage) return `${this._buttonPrevMarkupHtml(data)}` + `${this._buttonNextMarkupHtml(data)}`;
        if (data.page === data.totalPage) return `${this._buttonPrevMarkupHtml(data)}`;
    }
    _buttonPrevMarkupHtml(data = "") {
        return `<button class="btn--inline pagination__btn--prev">
              ...
              <span>${data.page === data.totalPage ? "Previous" : `Page ${data.page - 1}`}</span>
            </button>`;
    }
...
exports.default = new ViewPagResult();

},{"url:../../img/icons.svg":"fd0vu","./view":"b3RBV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"atMiN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class viewBookmark extends (0, _viewDefault.default) {
    //private field
    _data;
    ...
    #generateHtml(data = "", hashId) {
        return `<li class="preview">
            <a class="preview__link ${data.recipe.id === hashId ? "preview__link--active" : ""}" href="#${data.recipe.id}">
              <figure class="preview__fig">
              ...
              <div class="preview__data">
                ...
                <div class="preview__user-generated ${data.recipe.key ? "" : "hidden"}">
                  <svg>
                    <use href="${0, _iconsSvgDefault.default}#icon-user"></use>
                  </svg>
                </div>
...
},{"url:../../img/icons.svg":"fd0vu","./view":"b3RBV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3pzpZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class viewAddRecipe extends (0, _viewDefault.default) {
    //public field
    //private field
...
exports.default = new viewAddRecipe();

},{"url:../../img/icons.svg":"fd0vu","./view":"b3RBV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequireb2ed", {}, "./", "/")

//# sourceMappingURL=fork-app.4a59a05f.js.map
